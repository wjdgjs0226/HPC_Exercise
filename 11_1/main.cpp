...
int main(int argc, char* argv[])
{
    ...
    opts.add_options()
        ("gpoints", po::value<int>()->default_value(20001),"Numer of grid points")
        ("ts_size", po::value<double>()->default_value(0.00001), "Timestep size")
        ("ts_number", po::value<int>()->default_value(20000), "Number of timesteps")
    ...
    double L = 5.0; // Length of the domain
